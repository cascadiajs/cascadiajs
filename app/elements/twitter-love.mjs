export default function Testimonials({ html }) {
  return html`
    <style>
    ...
    <section id="testimonials">
          <div>
            <div>  
              <blockquote class="twitter-tweet"><p lang="en" dir="ltr">i always have a good time at <a href="https://twitter.com/CascadiaJS?ref_src=twsrc%5Etfw">@CascadiaJS</a>. still one of my fave talks of all time there but more imptly the people and the vibe that <a href="https://twitter.com/crtr0?ref_src=twsrc%5Etfw">@crtr0</a> and co create make you feel the JS community in a way that very very few are able to do.<br><br>join Sept 18-19 in Seattle! <a href="https://t.co/xoOT9pkMSl">https://t.co/xoOT9pkMSl</a></p>&mdash; swyx (@swyx) <a href="https://twitter.com/swyx/status/1955883084236382704?ref_src=twsrc%5Etfw">August 14, 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
            <div>
