    ...
    <div id="day-one" class="day">
        ...
        <div class="day-content">
            <div class="main track">   
                ...
                ${ renderSpeaker("11:30", talks.find(t => t.speaker.slug === 'logan-gore'))}
                ...
                ${ renderSpeaker("16:00", talks.find(t => t.speaker.slug === 'jacob-lee'))}
