      ...
      <minimal-layout>
        ...
        <section class="details">
          ...
          <div class="narrow">
            ...
            <h3>Opening Mixer (1 Available)</h3>
            <p>Branding and recognition at the opening social event that kicks off the conference. This option associates your brand with one of the highest-energy, most well-attended moments of the event.</p>

            <h3>Karaoke (1 Available)</h3>
