    ...
    <minimal-layout>
        ...
        <table id="packages-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Sold out!</td>
              <td>Sold out!</td>
              <td><span class="strike">12</span> 1 left!</td>
              <td>Multiple</td>
              <td>Multiple</td>
              <td>Unlimited</td>
            </tr>
      ...
      <section class="details">
        ...
        <div class="narrow">
          ...
          <h3>Workshop <span class="strike">(1 left!)</span> Sold out!</h3>
          ...
          <h3>Welcome Reception on May 31 <span class="strike">(1 Available)</span> Sold out!</h3>
          ...
          <h3>Networking Mixer on June 1 (1 left!)</h3>
