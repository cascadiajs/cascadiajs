---
title: Lead Capture
excerpt: Information about lead capture for sponsors of CascadiaJS 2026
---
<div id="toc">
<h2>On This Page</h2>
    <ul>
...
We're using an app called Orca Scan for lead capture at this year's event. Attendee badges will have a QR code printed on the front of their badge. To save an attendee's information, you'll just need to scan their badge. Below is some information on how to get set up and use the app. 
...
Attendees who registered for the conference after May 24 will **not** have a QR code on their badge, but you can add them to your list manually. To do so, just select the + icon in the upper left hand corner of the app, click each field to enter the attendee's information, and select the "Save & Close" button.
