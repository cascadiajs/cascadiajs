...
<h2>On This Page</h2>
    <ul>
        ...
        <li><a href="#support">Support the program</a></li>
    </ul>
</div>
...
2. Is able to attend both days of the conference (June 1 and 2), and
...
<i class="fas fa-heart"></i> If you can't afford this ticket, you'll be considered for full financial aid. Applicants that are selected for full financial aid will be offered a Premium ticket for $15. All other qualified applicants will be offered a discounted General Admission ticket. 
