const sponsors = {
  ...
  2026: [
    ...
    },
    {
      ...
      name: "OneBrief",
      url: "https://www.onebrief.com",
      description: "Onebrief is building collaboration and AI-powered workflow software for complex, real-world planning environments—where clarity, speed, and accuracy matter. Our platform helps teams operate more effectively in high-stakes, constrained settings by unifying information across systems, teams, and locations.\n\nWe're a remote-first team of builders from diverse backgrounds, focused on creating meaningful impact—alongside a strong culture of ownership and craft. Backed by leading investors including General Catalyst, Battery Ventures, and Insight Partners, and a Y Combinator alum, we're growing quickly and excited to connect with engineers who want to tackle hard problems and shape the world we live in.\n\nAt CascadiaJS, we'll have Booth #1 both days—come meet the team, learn what we're building, and explore open roles.\n\nDon't miss Jeff Otaño's (Senior Software Engineering Manager) lightning talk: [From Skeptics to Champions: Building an AI Platform Your Engineers Actually Trust](/2026/talks/building-an-ai-platform-your-engineers-actually-trust). He'll share how we moved from decentralized, individual AI tool usage to a governed, measurable, and scalable AI platform—turning experimentation into real organizational capability.\n\nWe're also a host of Cascadia's networking event on June 1—come hang out, meet fellow engineers, and connect with the Onebrief team.\n\n <h2>Open roles</h2> \n\n <h3>Senior Software Engineer, Full-stack - Remote (US)</h3>\n\nThis is a senior IC role with meaningful ownership inside a team’s scope. You’ll lead multi-sprint initiatives, contribute to architectural direction, and partner closely with Product, Design, and Engineering to ship resilient, thoughtful software. Learn more about this role: https://jobs.ashbyhq.com/onebrief/605a6856-fb5d-4d61-8d2f-64a2b1ce3f2c \n\n<h3>Staff Software Engineer, Full-stack - Remote (US)</h3>\n\nThis role sits at the intersection of architecture, product strategy, and distributed systems design. Current challenges include real-time collaboration infrastructure, complex planning interfaces, observability, AI-assisted workflows, and scalable platform foundations across React, TypeScript, Node.js, PostgreSQL, Redis, Kubernetes, and AWS. Learn more about this role: https://jobs.ashbyhq.com/onebrief/89a18894-2c21-4a9c-afb9-8521cc18675e\n\n<h3>Outcome Engineer (Early Career) - Remote (US)</h3>\n\n This role sits somewhere between software engineering, AI systems design, platform engineering, and product experimentation. You’ll help build the internal systems that support agentic workflows, automated governance, evaluation frameworks, observability loops, and AI-assisted software development. Learn more about this role: https://jobs.ashbyhq.com/onebrief/a88e10d4-66d8-4911-99e3-3d20351e73d9 \n\nLearn more: https://www.onebrief.com/life-at-onebrief"
    },
    {
      id: "grow-therapy",
      tier: "silver",
